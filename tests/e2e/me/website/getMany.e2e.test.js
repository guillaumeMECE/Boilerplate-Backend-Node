...
const routePath = () => `/v${API_VERSION}/bo/me/websites`;
...
describe(routePath(), () => {
    ...
    beforeEach(async () => {
        await clearDatabase();
        try {
            testAccountNotAdmin = await createSeed.createClient('guillaumetst');
    ...
    describe('[CASE-1] - client token send without website link ', () => {
