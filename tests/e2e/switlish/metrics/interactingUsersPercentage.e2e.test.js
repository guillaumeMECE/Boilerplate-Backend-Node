...
const routePath = () => `/v${API_VERSION}/bo/switlish/metrics/interacting-users-percentage`;
...
describe(routePath(), () => {
    ...
    beforeEach(async () => {
        ...
        try {
            ...
            testAccount = await createSeed.createClient('interactinguserspercentage', 'admin');
        } catch (error) {
