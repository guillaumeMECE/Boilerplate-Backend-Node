...
const deletedUsersRouteController = buildRouteCallback(`${__dirname}/deletedUsers`);
...
describe('[Switlish > Analytics] - deletedUsers', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid header', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await deletedUsersRouteController(req, res);
            } catch (error) {
