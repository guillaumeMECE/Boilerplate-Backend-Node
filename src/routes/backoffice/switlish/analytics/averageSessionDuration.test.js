...
const averageSessionDurationRouteController = buildRouteCallback(`${__dirname}/averageSessionDuration`);
...
describe('[Switlish > Analytics] - averageSessionDuration', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid header', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await averageSessionDurationRouteController(req, res);
            } catch (error) {
