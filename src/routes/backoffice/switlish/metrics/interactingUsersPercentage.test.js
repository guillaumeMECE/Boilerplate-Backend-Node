...
const interactingUsersPercentageRouteController = buildRouteCallback(`${__dirname}/interactingUsersPercentage`);
...
describe('[Switlish > Metrics] - interactingUsersPercentage', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid header', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await interactingUsersPercentageRouteController(req, res);
            } catch (error) {
