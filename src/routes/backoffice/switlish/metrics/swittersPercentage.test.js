...
const swittersPercentageRouteController = buildRouteCallback(`${__dirname}/swittersPercentage`);
...
describe('[Switlish > Metrics] - swittersPercentage', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid header', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await swittersPercentageRouteController(req, res);
            } catch (error) {
