...
const averageFriendsRouteController = buildRouteCallback(`${__dirname}/averageFriends`);
...
describe('[Switlish > Metrics] - averageFriends', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid header', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await averageFriendsRouteController(req, res);
            } catch (error) {
