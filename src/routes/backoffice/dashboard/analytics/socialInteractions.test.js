...
const socialInteractionsRouteController = buildRouteCallback(`${__dirname}/socialInteractions`);
...
describe('[Dashboard > Analytics] - socialInteractions', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid website_id', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await socialInteractionsRouteController(req, res);
            } catch (error) {
