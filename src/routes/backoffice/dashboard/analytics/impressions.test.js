...
const impressionsRouteController = buildRouteCallback(`${__dirname}/impressions`);
...
describe('[Dashboard > Analytics] - Impressions', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid website_id', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await impressionsRouteController(req, res);
            } catch (error) {
