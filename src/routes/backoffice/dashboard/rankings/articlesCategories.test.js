...
const articlesCategoriesRouteController = buildRouteCallback(`${__dirname}/articlesCategories`);
...
describe('[Dashboard > Rankings] - articlesCategories', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid website_id', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await articlesCategoriesRouteController(req, res);
            } catch (error) {
