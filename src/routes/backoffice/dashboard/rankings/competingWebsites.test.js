...
const competingWebsitesRouteController = buildRouteCallback(`${__dirname}/competingWebsites`);
...
describe('[Dashboard > Rankings] - competingWebsites', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid website_id', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await competingWebsitesRouteController(req, res);
            } catch (error) {
