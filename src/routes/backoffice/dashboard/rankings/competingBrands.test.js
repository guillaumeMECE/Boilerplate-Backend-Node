...
const competingBrandsRouteController = buildRouteCallback(`${__dirname}/competingBrands`);
...
describe('[Dashboard > Rankings] - competingBrands', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid website_id', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await competingBrandsRouteController(req, res);
            } catch (error) {
