...
const leastSwittedRouteController = buildRouteCallback(`${__dirname}/leastSwitted`);
...
describe('[Dashboard > Rankings] - leastSwitted', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid website_id', () => {
        it('should return status(200) ', async () => {
            ...
            // Act
            try {
                await leastSwittedRouteController(req, res);
            } catch (error) {
