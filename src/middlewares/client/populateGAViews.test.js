...
const populateGAViews = require('./populateGAViews');
...
describe('[Middlewares > Client] - PopulateGAViews', () => {
    // Seeds
    ...
    describe('[CASE-0] req with valid \'website_id\'', () => {
        it('should next ', async () => {
            ...
            // Act
            try {
                await populateGAViews(req, res, next);
            } catch (error) {
            ...
            expect(req.rigorous.GAViews).toBeDefined();
        });
    });
    ...
    describe('[CASE-1] req with invalid \'website_id\'', () => {
        it('should return status(500)', async () => {
            ...
            expect(req.rigorous.GAViews).toBeUndefined();
        });
    });
